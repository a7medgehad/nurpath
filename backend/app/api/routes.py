...
def retrieval_health(
    ...
    return RetrievalHealthResponse(
        ...
        reranker_enabled=bool(diagnostics["reranker_enabled"]),
        reranker_provider=str(diagnostics["reranker_provider"]),
        reranker_model_name=str(diagnostics["reranker_model_name"]),
        ...
        notes=[
            ...
            f"Reranker enabled={diagnostics['reranker_enabled']}",
            f"Reranker provider={diagnostics['reranker_provider']}",
            f"Reranker model={diagnostics['reranker_model_name']}",
